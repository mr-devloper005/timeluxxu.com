...
const inputClass = 'h-[52px] w-full rounded-[200px] border border-[var(--editable-border)] bg-white px-5 text-sm font-bold text-[var(--slot4-page-text)] outline-none transition placeholder:text-[var(--slot4-muted-text)] focus:border-[var(--slot4-accent)]'
const buttonClass = 'inline-flex h-[52px] w-full items-center justify-center rounded-[200px] bg-[var(--slot4-accent)] px-6 text-sm font-bold text-[var(--slot4-on-accent)] transition hover:bg-[var(--slot4-dark-bg)] active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-60'
