export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'timeluxxu',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Timeluxxu',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'timeluxxu.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://timeluxxu.com',
